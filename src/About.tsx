        ...
        return (
            <div>
                ...
                <div id="aboutHolder">
                    ...
                    through a mix of Facebook's open source web development framework, 
                    <a href="https://reactjs.org/">React</a>, Microsoft's <a href="https://www.typescriptlang.org/">TypeScript</a>, and some music APIs including 
                    Spotify's, Apple Music's, and Deezer's (plus a bunch of other packages/libraries). The code is published on GitHub under the GNU Lesser General Public License v2.1.</p>
                </div>
                <Footer />
            </div>
        )
